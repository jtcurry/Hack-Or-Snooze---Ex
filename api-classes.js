...
class User {
  ...
  //Get users details from API and set to this instance
  async userDetails() {
  ...
  //Add story to a users favorites and post to API
  ...
  //Remove story from users favorites and delete from API
...
class Story {
  ...
  // Patch request to update user when create a new story
  async updateUserStory(user, storyData) {
    const response = await axios({
